...
//          $user_id = $_SESSION['user_id'];
        ...
        <h2 class="list-post-heading">Danh sách bài viết: <span><?php $rowFullname = mysqli_fetch_array($sqlFullname); echo $rowFullname['fullname'] ?></span></h2>
        <div class="content">
            <!--Post-->
            <div class="posts">
                <?php
